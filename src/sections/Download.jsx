            ...
            <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex256 max-md:flex-100">
              ...
              <ul className="flex flex-wrap items-center gap-6">
                {links.map(({ id, url, icon }) => (
                  <li
                    key={id}
                    className="download_tech-link download_tech-link_last-before download_tech-link_last-after_before flex items-center
                  ...
                  >
                    ...
                    >
                      ...
                      <img
                        ...
                        alt="lines"
                        className="absolute size-13/20 object-contain z-10"
                      />
